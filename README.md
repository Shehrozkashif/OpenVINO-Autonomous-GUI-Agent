...
[![Tests](https://img.shields.io/badge/tests-516%20passing-brightgreen)](#running-tests)
...
├── tests/
│   ├── unit/                  # 516 tests: fast, no backend or desktop required
...
# Unit tests: 516 without PyQt6, 551 with it (the GUI suite). Fast, no backend
# or desktop required.
pytest
