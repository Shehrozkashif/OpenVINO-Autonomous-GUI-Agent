...
[![Tests](https://img.shields.io/badge/tests-555%20passing-brightgreen)](#running-tests)
...
├── tests/
│   ├── unit/                  # 555 tests: fast, no backend or desktop required
...
# Unit tests: 555 without PyQt6, 590 with it (the GUI suite). Fast, no backend
# or desktop required.
pytest
