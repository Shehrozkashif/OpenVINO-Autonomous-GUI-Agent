...
[![Tests](https://img.shields.io/badge/tests-559%20passing-brightgreen)](#running-tests)
...
├── tests/
│   ├── unit/                  # 559 tests: fast, no backend or desktop required
...
# Unit tests: 559 without PyQt6, 594 with it (the GUI suite). Fast, no backend
# or desktop required.
pytest
