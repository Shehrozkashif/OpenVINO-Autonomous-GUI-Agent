...
[![Tests](https://img.shields.io/badge/tests-524%20passing-brightgreen)](#running-tests)
...
├── tests/
│   ├── unit/                  # 524 tests: fast, no backend or desktop required
...
# Unit tests: 524 without PyQt6, 559 with it (the GUI suite). Fast, no backend
# or desktop required.
pytest
